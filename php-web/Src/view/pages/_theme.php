                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-danger" id="nav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSite">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item"><a title="Home" class="nav-link text-white" id="homePage" href="<?= '' ?>">Home</a></li>
                            <li class="nav-item"><a title="Sobre" class="nav-link text-white" id="sobrePage" href="<?= 'sobre' ?>">Sobre</a></li>
                            <!-- <li class="nav-item"><a title="Cardápio" class="nav-link text-white" id="cardapioPage" href="<?= 'cardapio' ?>">Cardápio</a></li>
                            </li> -->
                            <li class="nav-item"><a title="Ver Pedidos" class="nav-link text-white" id="verPedidoPage" href="<?= 'ver-pedido' ?>">Lista Espera</a>
                            <li class="nav-item">
                                <a title="Fazer Pedido" class="nav-link text-white" id="pedidoPage" href="<?= 'pedido' ?>">Cardápio</a>
                            </li>
    
                            <?php if (isset($_SESSION['admin'])) : ?>
                                <li class="nav-item">
                                    <a title="" class="nav-link text-white" href="<?= ''?>">Área Restrita</a>
                                </li>
                            <?php endif; ?>
                        </ul>
                        ...
                        <?php if (isset($_SESSION['user_cliente'])) : ?>
                            <a href="<?='cliente/logout' ?>" class="text-white logout">Terminar Sessão</a>
                        <?php else : ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 mb-3">
                    ...
                    <div class="list-group text-center">
                        ...
                        <a href="<?= "sobre" ?>" class="list-group-item list-group-item-action list-group-item-primary">Sobre</a>
                        <a href="<?= "cardapio" ?>" class="list-group-item list-group-item-action list-group-item-primary">Cardápio</a>
                        <a href="<?= "ver-pedido" ?>" class="list-group-item list-group-item-action list-group-item-primary">Pedido</a>
                        <a href="<?= "pedido" ?>" class="list-group-item list-group-item-action list-group-item-primary">Ver Pedidos</a>
                    </div>
                </div>
