<!-- Card -->
<div id="pastelcard" class="row justify-content-sm-center mx-0 pt-5 px-3" style="background-color: rgb(255, 210, 0);">
  <!-- col-md-4 -->
  ...
  <div class="col-sm-6 col-md-4">
    <div class="card mb-5">
      ...
      <img src="<?= assets('image/Originals/home.jpeg') ?>" alt="texto-alternativo" class="card-img-top">
      <div class="card-body">
        ...
        <p class="card-text text-justify">
          ...
          <a onclick="maravilha()" class="text-primary " id="btn_mar">
            Leia mais
          </a>
        </p>
      </div>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="card mb-5">
      ...
      <img src="<?= assets('image/Originals/home.jpeg') ?>" alt="zzzzzzz" class="card-img-top">
