...
<head>
  ...
  <title><?= $title; ?></title>
  <link rel="stylesheet" href="<?= assets('site/css/opcao.css'); ?>">
...
<body>
    ...
    <?php if ($this->section('sidebar')) :
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-danger" id="nav-menu">
        <a class="navbar-brand h1 mb-0" href="#<?= url('area-restrita') ?>">
          <img src="<?= assets('site/image/logo.png') ?>" alt="logo" width="30" height="30">
        </a>
      </nav>
      <!------------- DIV DE LOGIN------------->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row justify-content-center">
                <form action="<?= url('cliente/check-login') ?>" method="POST" autocomplete='off' id="login-app" onsubmit="return validate_jquery()">
                  <div class="form-row">
  ...
  <script src="<?= assets('site/js/bootstrap.bundle.min.js'); ?>" type="text/javascript"></script>
  <script src="<?= assets('site/js/variaveis.js'); ?>" type="text/javascript"></script>
  <?= $this->section('script'); ?>
</body>
