  ...
  <div class="row ">
    <div class="col-sm-3  mt-5">
      <div class="list-group" id="list-tab" role="tablist">
        <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-pedido" role="tab" aria-controls="home">Pedidos Enviados</a>
        <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-pastel" role="tab" aria-controls="profile">Adicionar pastel</a>
        <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-bebida" role="tab" aria-controls="messages">Adicionar Bebida</a>
      </div>
    </div>
                        ...
                        <?php if (count($pastel_restrito) != 0) : ?>
                          <?php foreach ($pastel_restrito as $cardapio) : ?>
                            ...
                            <tr>
                              ...
                              <td><a href="?pag=area_restrita/editar_pastel/<?php echo $cardapio->id_cardapio; ?>" class="text-success">Editar</a></td>
                        ...
                        <?php foreach ($bebidas_restrita as $bebida) : ?>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="?pag=area_restrita/editar_bebida/<?php echo $bebida->id_bebida; ?>" class="text-success">Editar</a>
                            </td>
